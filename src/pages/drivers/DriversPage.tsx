...
import { Search, FileText, Download, Plus, Filter, CalendarClock, Shield } from 'lucide-react';
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-xl">
            ...
            >
              ...
              <p className="mt-2 text-aximo-text-secondary max-w-2xl">
                Efficiently manage your driver fleet, monitor performance metrics, and ensure compliance with regulatory requirements
              </p>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="flex gap-2 flex-wrap sm:flex-nowrap">
              ...
              <Button size="sm" className="bg-aximo-primary text-white hover:bg-aximo-highlight" onClick={handleAddDriver}>
              ...
              >
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-aximo-text-secondary">License and CPC renewals</p>
                  </div>
                </div>
