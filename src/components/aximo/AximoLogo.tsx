    ...
    <div className="flex items-center">
      ...
      >
        <path
          ...
          className={`${variant === 'white' ? 'fill-white' : 'fill-aximo-primary'}`}
        />
        <path
          d="M12 12L2 7V17L12 22L22 17V7L12 12Z"
          className={`${variant === 'white' ? 'fill-white opacity-60' : 'fill-aximo-primary opacity-60'}`}
        />
        <circle 
          cx="12" 
          cy="7" 
          r="1.5" 
          className={`${variant === 'white' ? 'fill-white' : 'fill-aximo-light'}`} 
        />
      </svg>
